...
namespace Figlut.MonoDroid.Toolkit.Utilities.Serialization
{
            ...
            foreach (JObject jColumn in jObject["Columns"])
            {
                ...
                if (!column.AutoIncrement)
                {
                    ...
                    if (token != null)
                    {
						...
						} else if (column.DataType == typeof(System.UInt16)) {
						...
						} else if (column.DataType == typeof(System.UInt32)) {
						...
						} else if (column.DataType == typeof(System.UInt64)) {

namespace Figlut.MonoDroid.Toolkit.Data
{
    ...
    using Figlut.MonoDroid.Toolkit.Web.Client.DataProgress;
	using Figlut.MonoDroid.Toolkit.Web.Client.REST;
    ...
    public class EntityCache<K, E> : IEnumerable<E> where E : class
    {
        ...
        {
            return GetDataTable(properties, exactMatch, shapeColumnNames, null);
        }

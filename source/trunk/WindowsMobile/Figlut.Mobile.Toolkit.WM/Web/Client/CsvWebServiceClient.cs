namespace Figlut.Mobile.Toolkit.Web.Client
{
    ...
    public class CsvWebServiceClient : WebServiceClient, IMimeWebServiceClient
    {
        ...
        public T CallService<T>(
            ...
            bool wrapWebException)
        {
            if (deserializeToDotNetTObject && DataHelper.GetGenericCollectionItemType(typeof(T)) == null)
            {
            ...
            if (deserializeToDotNetTObject)
            {
                ...
                //object deserializedObject = GOC.Instance.GetSerializer(SerializerType.CSV).DeserializeFromText(typeof(T), csvOutput);

namespace Figlut.Mobile.Toolkit.Data.DB.SQLQuery
{
    ...
    public class SqlQuery
    {
        ...
        public SqlQuery()
        {
            ...
            _sqlParameters = new List<SqlCeParameter>();
        ...
        protected List<SqlCeParameter> _sqlParameters;
        ...
        public List<SqlCeParameter> SqlCeParameters
        {
        ...
        public void AppendWhereColumns(List<WhereClauseColumn> whereClause)
        {
            ...
            foreach (WhereClauseColumn whereColumn in whereClause)
            {
                ...
                {
                    string parameterName = string.Format("@{0}", Guid.NewGuid().ToString().Replace("-", string.Empty));
                    ...
                    _sqlParameters.Add(new SqlCeParameter(parameterName, whereColumn.ColumnValue));
        ...
        public bool SqlParameterExists(List<SqlCeParameter> sqlParameters, string parameterName)
        {
            foreach (SqlCeParameter p in sqlParameters)
            {

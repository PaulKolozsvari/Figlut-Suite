namespace Figlut.Mobile.Toolkit.Data
{
    ...
    public class EntityCacheUnique
    {
        ...
        public EntityCacheUnique(Type entityType)
        {
            ...
            _updateEntities = new Dictionary<Guid, object>();
        }
        ...
        protected Dictionary<Guid, object> _updateEntities;
        ...
        {
            ValidateEntityType(e);
            if (!_addedEntities.ContainsKey(entityId) && !_updateEntities.ContainsKey(entityId))
            {
                _updateEntities.Add(entityId, e);
            }
        }
            ...
            string entityIdColumnName)
        {
            ...
            DataTable result = EntityReader.GetDataTable(shapeColumnNames, _entityType, entityIdColumnName);

namespace Figlut.Mobile.Toolkit.Data
{
    ...
    public class DataHelper
    {
        ...
        public static List<E> ParseSqlResultSetToEntities<E>(SqlCeResultSet resultSet) where E : class
        {
                    ...
                    foreach (PropertyInfo p in typeof(E).GetProperties())
                    {
                        ...
                        catch (Exception ex)
                        {
                            throw new Exception(string.Format(
                                ...
                                p.Name,
                                typeof(SqlCeUpdatableRecord).FullName),
                                ex);
                        }
        ...
        public static T ParseSqlCeResultSetToScalarValue<T>(SqlCeResultSet resultSet)
        {
            if (!resultSet.HasRows)
            {
        ...
        public static object ParseSqlCeUpdatableRecordToEntity(SqlCeUpdatableRecord record, Type entityType)
        {
        ...
        public static E ParseSqlCeUpdatableRecordToEntity<E>(SqlCeUpdatableRecord record) where E : class
        {
            return (E)ParseSqlCeUpdatableRecordToEntity(record, typeof(E));
        }
        ...
        public static DataTable GetDataTableFromEntities<E>(List<E> entities)
        {

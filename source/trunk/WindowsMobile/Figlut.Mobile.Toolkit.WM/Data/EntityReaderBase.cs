...
using Newtonsoft.Json.Linq;
    ...
    public class EntityReader
    {
        ...
        public static DataTable GetDataTable(bool shapeColumnNames, Type entityType, string entityIdColumnName)
        {
        ...
        {
            return GetAllPropertyNames(shapeColumnNames, entityType, null);
        }

        public static List<string> GetAllPropertyNames(bool shapeColumnNames, Type entityType, List<string> hiddenProperties)
        {
        ...
        public static void SetPropertyValue(string propertyName, object entity, object value, bool typeCastValue)
        {
            ...
            if (typeCastValue)
            {
                p.SetValue(entity, ConvertValueTypeTo(value, p.PropertyType), null);
            }
            else
            {
        ...
        public static void CopyProperties(object sourceObject, object destinationObject, bool swallowExceptionsOnMismatch)
        {
            ...
            foreach (PropertyInfo pSource in typeSource.GetProperties())
            {
                try
                {
                    ...
                    object valueSource = pSource.GetValue(sourceObject, null);
                    if (pSource.PropertyType.IsEnum)
                    {
                        ...
                        pDestination.SetValue(destinationObject, valueSourceEnum, null);
                    }
                    else
                    {
                        pDestination.SetValue(destinationObject, valueSource, null);
                    }
                }
                catch (Exception ex)
                {

namespace Figlut.Server.Toolkit.Utilities.Cab
{
    ...
    public class CabInfo : IEnumerable<CabResourceInfo>
    {
        ...
        {
            int i = 1;
            foreach (CabResourceInfo resource in _cabResources.Values)
            {
                resource.Index = i;
                i++;
            }
        ...
        private void AppendINFSourceDisksNamesBlock(StringBuilder INF)
        {
            ...
            foreach (CabResourceInfo c in _cabResources.Values)
            {
                c.AppendINFSourceDiskNameBlock(INF);//Directories
            }
            INF.AppendLine();
        }
        ...
        private void AppendINFSourceDisksFilesBlock(StringBuilder INF)
        {
            ...
            foreach (CabResourceInfo c in _cabResources.Values)
            {
                c.AppendINFSourceDiskFileBlock(INF);
            }
            INF.AppendLine();
        }
        ...
        private void AppendINFDestinationDirsBlock(StringBuilder INF)
        {
            ...
            foreach (CabResourceInfo c in _cabResources.Values)
            {
                c.AppendINFDestinationDirBlock(INF);
            }
            INF.AppendLine();
        }
        ...
        private void AppendINFOperationsBlock(StringBuilder INF)
        {
            foreach (CabResourceInfo c in _cabResources.Values)
            {
                c.AppendINFCopyFileOperationBlock(INF);
            }
            INF.AppendLine();
        }

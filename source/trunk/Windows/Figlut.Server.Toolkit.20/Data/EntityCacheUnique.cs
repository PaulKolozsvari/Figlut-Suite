namespace Figlut.Server.Toolkit.Data
{
    ...
    public class EntityCacheUnique
    {
        ...
        public virtual object GetEntityByProperty(string propertyName, object propertyValue, bool exactMatch)
        {
            ...
            Dictionary<Guid, object> tempResult = GetEntitiesByProperties(properties, exactMatch);
            object[] result = new object[tempResult.Count];
            tempResult.Values.CopyTo(result, 0);
            return tempResult.Count < 1 ? null : result[0];
        }

    ...
    public class SqlQueryRunnerConfig
    {
            ...
            set
            {
                if(string.IsNullOrEmpty(value))
                {
                    throw new NullReferenceException(string.Format(
                        "SqlQueryRunnerAssemblyPath may not be null or empty on {1}.",
        ...
        public string SqlQueryRunnerFullTypeName
        {
            ...
            set
            {
                ...
                {
                    throw new NullReferenceException(string.Format(
                        "SqlQueryRunnerFullTypeName may not be null or empty on {0}.",
                        this.GetType().FullName));
                }
        ...
        public byte[] QueryRunnerAssemblyBytes
        {
            ...
            set 
            {
                ...
                {
                    throw new NullReferenceException(string.Format(
                        "QueryRunnerAssemblyBytes may not be null or have a 0 length on {0}.",
                        this.GetType().FullName));
                }

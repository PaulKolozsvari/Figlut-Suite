namespace Figlut.Server.Toolkit.Web.Client
{
    ...
    public class JsonWebServiceClient : WebServiceClient, IMimeWebServiceClient
    {
        ...
        {
            string jsonOutput;
            return CallService<T>(queryString, requestPostObject, verb, out jsonOutput, true, timeout);
        }
            ...
            int timeout)
        {
            ...
            {
                jsonInput = GOC.Instance.GetSerializer(SerializerType.JSON).SerializeToText(requestPostObject);
            }

namespace Figlut.Server.Toolkit.Data.DB
{
    ...
    public static class SqlConnectionExtensions
    {
        ...
        /// <returns></returns>
        public static EntityCache<string, ForeignKeyInfo> GetTableForeignKeys(this SqlConnection connection, string tableName)
        {
        ...
        private static EntityCache<string, ForeignKeyInfo> GetForeignKeysFromSqlDataReader(SqlDataReader reader)
        {

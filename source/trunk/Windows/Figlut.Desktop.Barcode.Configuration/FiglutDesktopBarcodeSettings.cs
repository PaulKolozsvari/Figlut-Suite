namespace Figlut.Desktop.Barcode.Configuration
{
    ...
    public class FiglutDesktopBarcodeSettings : Settings
    {
        #region Constructors

        public FiglutDesktopBarcodeSettings()
            : base()
        {
        }

        public FiglutDesktopBarcodeSettings(string filePath)
            : base(filePath)
        {
        }

        public FiglutDesktopBarcodeSettings(string name, string filePath)
            : base(name, filePath)
        {
        }

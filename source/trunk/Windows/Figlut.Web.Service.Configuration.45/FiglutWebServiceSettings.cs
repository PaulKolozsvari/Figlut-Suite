namespace Figlut.Web.Service.Configuration
{
    ...
    public class FiglutWebServiceSettings : Settings
    {
        ...
        [SettingInfo("Service", AutoFormatDisplayName = true, Description = "The port number on which the Figlut Web Service should listen for requests from clients i.e. http://localhost:{port_number}/{suffix} e.g. http://localhost:2983/Figlut.", CategorySequenceId = 1)]

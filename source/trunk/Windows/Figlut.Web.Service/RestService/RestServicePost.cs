namespace Figlut.Server
{
    ...
    public partial class RestService
    {
        ...
        [OperationContract]
        [WebInvoke(UriTemplate = "/sqltable/{tableName}", Method = "POST")]
        Stream PostEntityRoot(string tableName, Stream inputStream)
        {
            try
            {
                ...
                return PostEntity(tableName, inputStream, inputSerializer, outputSerializer);
            }
            catch (Exception ex)
            {
        ...
        [OperationContract]
        [WebInvoke(UriTemplate = "/sqltable/{tableName}/xml", Method = "POST")]
        Stream PostEntityXml(string tableName, Stream inputStream)
        {
            try
            {
                return PostEntity(
        ...
        [OperationContract]
        [WebInvoke(UriTemplate = "/sqltable/{tableName}/json", Method = "POST")]
        Stream PostEntityJson(string tableName, Stream inputStream)
        {
            try
            {
                return PostEntity(
        ...
        [OperationContract]
        [WebInvoke(UriTemplate = "/sqltable/{tableName}/csv", Method = "POST")]
        Stream PostEntityCsv(string tableName, Stream inputStream)
        {
            try
            {
                return PostEntity(
        ...
        Stream PostEntity(string tableName, Stream inputStream, ISerializer inputSerializer, ISerializer outputSerializer)
        {
            LogRequest();
            ...
            table.Insert(inputEntities, true);
            ...
            else
            {
                ...
                WebOperationContext.Current.OutgoingResponse.StatusDescription = string.Format("{0} records inserted into {1}.", inputEntities.Count, table.TableName);
            }
